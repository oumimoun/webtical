...
<div class="basis-1/5 p-3 bg-gray-100 rounded-md shadow-md text-black font-semibold min-h-screen sidebar hidden min-[1112px]:block ">
    <!-- Sidebar content -->
    <div class="grid space-y-8 space-x-4 justify-center fixed">
        ...
        <div class="flex space-x-4">
            <div>
                <a href="showprofile.php?id=<?php echo $username; ?>" class="p-4 flex justify-between items-center font-medium text-lg text-black  hover:bg-gray-700 rounded-full hover:text-white duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
